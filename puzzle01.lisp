...
(Button -266 -66 50 50 0 (begin (flip000) (flip100)  (flip010)  (flip001)  (testWin)))
...
(Button -266 0 50 50 3 (begin (flip001) (flip101)  (flip011)  (flip002) (flip000) (testWin)))
...
(Button -266 66 50 50 6 (begin (flip002) (flip102)  (flip012)  (flip003) (flip001) (testWin)))
...
(Button -200 -66 50 50 1 (begin (flip010) (flip110)  (flip020) (flip000) (flip011)  (testWin)))
...
(Button -200 0 50 50 4 (begin (flip011) (flip111)  (flip021) (flip001) (flip012) (flip010) (testWin)))
...
(Button -200 66 50 50 7 (begin (flip012) (flip112)  (flip022) (flip002) (flip013) (flip011) (testWin)))
...
(Button -134 -66 50 50 2 (begin (flip020) (flip120)  (flip030) (flip010) (flip021)  (testWin)))
...
(Button -134 0 50 50 5 (begin (flip021) (flip121)  (flip031) (flip011) (flip022) (flip020) (testWin)))
...
(Button -134 66 50 50 8 (begin (flip022) (flip122)  (flip032) (flip012) (flip023) (flip021) (testWin)))
...
(Button -66 -66 50 50 0 (begin (flip100) (flip200) (flip000) (flip110)  (flip101)  (testWin)))
...
(Button -66 0 50 50 3 (begin (flip101) (flip201) (flip001) (flip111)  (flip102) (flip100) (testWin)))
...
(Button -66 66 50 50 6 (begin (flip102) (flip202) (flip002) (flip112)  (flip103) (flip101) (testWin)))
...
(Button 0 -66 50 50 1 (begin (flip110) (flip210) (flip010) (flip120) (flip100) (flip111)  (testWin)))
...
(Button 0 0 50 50 4 (begin (flip111) (flip211) (flip011) (flip121) (flip101) (flip112) (flip110) (testWin)))
...
(Button 0 66 50 50 7 (begin (flip112) (flip212) (flip012) (flip122) (flip102) (flip113) (flip111) (testWin)))
...
(Button 66 -66 50 50 2 (begin (flip120) (flip220) (flip020) (flip130) (flip110) (flip121)  (testWin)))
...
(Button 66 0 50 50 5 (begin (flip121) (flip221) (flip021) (flip131) (flip111) (flip122) (flip120) (testWin)))
...
(Button 66 66 50 50 8 (begin (flip122) (flip222) (flip022) (flip132) (flip112) (flip123) (flip121) (testWin)))
...
(Button 134 -66 50 50 0 (begin (flip200) (flip300) (flip100) (flip210)  (flip201)  (testWin)))
...
(Button 134 0 50 50 3 (begin (flip201) (flip301) (flip101) (flip211)  (flip202) (flip200) (testWin)))
...
(Button 134 66 50 50 6 (begin (flip202) (flip302) (flip102) (flip212)  (flip203) (flip201) (testWin)))
...
(Button 200 -66 50 50 1 (begin (flip210) (flip310) (flip110) (flip220) (flip200) (flip211)  (testWin)))
...
(Button 200 0 50 50 4 (begin (flip211) (flip311) (flip111) (flip221) (flip201) (flip212) (flip210) (testWin)))
...
(Button 200 66 50 50 7 (begin (flip212) (flip312) (flip112) (flip222) (flip202) (flip213) (flip211) (testWin)))
...
(Button 266 -66 50 50 2 (begin (flip220) (flip320) (flip120) (flip230) (flip210) (flip221)  (testWin)))
...
(Button 266 0 50 50 5 (begin (flip221) (flip321) (flip121) (flip231) (flip211) (flip222) (flip220) (testWin)))
...
(Button 266 66 50 50 8 (begin (flip222) (flip322) (flip122) (flip232) (flip212) (flip223) (flip221) (testWin)))
...
(set alreadyWon 0)
(set unlock (lambda () (if alreadyWon () (begin (print winTIME) (print "WIN") (set alreadyWon 1) (Button -200 -150 80 20 "Continue" (loadScene "winTime"))))))

(set testWin (lambda () (begin (set winTIME (* truth000 truth100 truth200 truth010 truth110 truth210 truth020 truth120 truth220 truth001 truth101 truth201 truth011 truth111 truth211 truth021 truth121 truth221 truth002 truth102 truth202 truth012 truth112 truth212 truth022 truth122 truth222)) (if (+ winTIME) (unlock) ()))))

(if (+ winTIME) (unlock) (flip111))
